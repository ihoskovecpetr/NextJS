...
function getToken(req) {
  const cookies = cookie__WEBPACK_IMPORTED_MODULE_11___default.a.parse(req ? req.headers.cookie || "" : document.cookie);
...
/* harmony import */ var _lib_checkLoggedIn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/checkLoggedIn */ "./lib/checkLoggedIn.js");
...
const IndexPage = ({
  ...
  const apolloClient = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_2__["useApolloClient"])();

  const signout = () => {
    document.cookie = cookie__WEBPACK_IMPORTED_MODULE_1___default.a.serialize("token", "", {
    ...
    apolloClient.cache.reset().then(() => {
      ...
      Object(_lib_redirect__WEBPACK_IMPORTED_MODULE_4__["default"])({}, "/signin");
    });
  };
...
IndexPage.getInitialProps = async context => {
  ...
  const {
    loggedInUser
  } = await Object(_lib_checkLoggedIn__WEBPACK_IMPORTED_MODULE_5__["default"])(context.apolloClient);

  if (!loggedInUser.user) {
    // If not signed in, send them somewhere more useful
    Object(_lib_redirect__WEBPACK_IMPORTED_MODULE_4__["default"])(context, "/signin");
  }
...
module.exports = __webpack_require__(/*! /Users/macuser/Desktop/code/with-apollo-auth/pages/index.js */"./pages/index.js");
